...
\def\paperID{29} % *** Enter the Paper ID here
\def\confName{CVPR}
\def\confYear{2025}
...
%%%%%%%%% TITLE - PLEASE UPDATE
\title{\LaTeX\ Leveraging Diffusion Based Image Generation to Investigate its Impact on Single Cell Detection Accuracy}  % **** Enter the paper title here
