...
Experiments with YOLOv8, YOLOv9 and RT-DETR reveal that training with synthetic data achieves comparable, and in some cases, slightly improved detection accuracies at lower Intersection over Union (IoU) thresholds.
A human expert survey demonstrates the high realism of generated images, with experts struggling to distinguish them from real microscopy images (accuracy $\sim$50\%).
